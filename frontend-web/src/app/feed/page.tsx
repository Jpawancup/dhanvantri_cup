        ...
        <Tabs defaultValue="foryou">
          <div className="sticky top-[108px] z-10 bg-white/80 md:bg-medical-grey/5 py-3 md:py-4 px-4 md:px-2 md:-mx-2 backdrop-blur-md md:rounded-2xl mb-2 md:mb-4 border-b md:border-b-0">
            <TabsList className="grid w-full grid-cols-2 bg-medical-grey/30 md:bg-white border-0 md:border shadow-sm rounded-xl p-1">
              <TabsTrigger value="foryou" className="data-[state=active]:bg-white md:data-[state=active]:bg-medical-green data-[state=active]:text-foreground md:data-[state=active]:text-white data-[state=active]:shadow-sm rounded-lg font-bold text-xs uppercase tracking-widest transition-all">
                For You
              </TabsTrigger>
              <TabsTrigger value="following" className="data-[state=active]:bg-white md:data-[state=active]:bg-medical-green data-[state=active]:text-foreground md:data-[state=active]:text-white data-[state=active]:shadow-sm rounded-lg font-bold text-xs uppercase tracking-widest transition-all">
                Following
              </TabsTrigger>
            </TabsList>
          </div>
          ...
          <TabsContent value="following" className="mt-0 md:mt-4 px-4 md:px-0">
            <div className="text-center py-16 space-y-3 bg-white rounded-3xl border border-dashed border-medical-grey/80 m-4 md:m-0">
              ...
              <p className="text-sm text-muted-foreground font-medium max-w-xs mx-auto leading-relaxed">
                Follow doctors and friends to see their health tips and updates here.
              </p>
            </div>
          </TabsContent>
        </Tabs>
